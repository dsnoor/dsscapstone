...
### Data Exploration
#### Capstone Dataset
This Capstone dataset contains training data covering four different locales namely US English (en-US), German (de-DE), Russian (ru-RU), and Finnish (fi-FI).  However, only "en-US" locale dataset is being analyzed in this report. 


Listed below are some highlevel stats (lines and word counts) for each dataset for English language. 
...
* The data file contains a single blog document on each line.
 ...
 Content Type | Filename | No. of Words | No. of Lines | Longest Line | Shortest Line
 --- | --- | --- | --- | --- | --- | --- 
